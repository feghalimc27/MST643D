...
public class VisualText : MonoBehaviour
{
    ...
    void state_class6()
    {
        ...
        if (Input.GetButtonDown("Jump")) { myState = States.class7; }
        else if (Input.GetButtonDown("Fire1")) { myState = States.dead1; }
    }
    ...
    void state_hallway7()
    {
        ...
        if (Input.GetButtonDown("Jump")) { myState = States.hallway8; }
        else if (Input.GetButtonDown("Fire1")) { myState = States.dead1; }    
    }
    ...
    void state_stairs()
    {
        ...
        if (Input.GetButtonDown("Jump")) { myState = States.stairs1; }
        else if (Input.GetButtonDown("Fire1")) { myState = States.dead5; }
    }
    ...
    void state_stairs2()
    {
        text.text = "You know, you seem like a clumsy person. No wonder I found you sleeping in class.";
    ...
    void state_stairs7()
    {
        text.text = "We mad it just in time.";
